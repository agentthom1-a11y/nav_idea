...
export default function Ideas() {
 ...
 <p className="text-white/60 mt-1">Capture, score, and develop content ideas with real-time AI research.</p>
 </div>
 ...
 <button className="flex items-center gap-2 px-4 py-2 glass-input text-sm font-medium hover:bg-transparent/5 w-full sm:w-auto justify-center">
 ...
 className="w-full bg-transparent text-xl font-semibold outline-none placeholder:text-white/50"
 />
 <textarea 
 placeholder="Add some details..." 
 value={newDesc}
 onChange={(e) => setNewDesc(e.target.value)}
 className="w-full bg-transparent outline-none resize-none placeholder:text-white/50 text-white/70 "
 rows={2}
 />
 ...
 className="glass-input px-2 py-1 text-sm outline-none"
 >
 ...
 className="px-4 py-1.5 text-sm font-medium text-white/70 hover:text-white /50 "
 >
 Cancel
 </button>
 <button 
 ...
 <Card key={idea.id} className="group hover:border-white/20 transition-colors">
 <CardContent className="p-5 flex flex-col h-full">
 <div className="flex items-start justify-between gap-4 mb-3">
 <div className="flex items-center gap-2">
 <span className={cn("text-[10px] font-bold px-1.5 py-0.5 rounded uppercase", idea.platform ? PLATFORM_COLORS[idea.platform] : "bg-transparent/10 text-white/70")}>
 ...
 title="Delete idea"
 className="text-white/50 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded hover:bg-transparent/10 "
 >
 ...
 <p className="text-white/60 /50 text-sm line-clamp-3 mb-4 flex-1">
 {idea.description}
 </p>
 
 <div className="flex items-center justify-between text-xs text-white/50 mt-auto pt-4 border-t border-white/5 ">
