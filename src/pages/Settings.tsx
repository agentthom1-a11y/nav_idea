...
export default function Settings() {
 ...
 <p className="text-white/60 mt-2">Manage your workspace account, brand context, and AI preferences.</p>
 </div>
 ...
 <p className="text-sm text-white/60 mt-1">Configure your workspace identity and display details.</p>
 </div>
 ...
 className="w-full px-3 py-2 bg-transparent/5 border border-white/10 rounded-md focus:ring-2 focus:ring-blue-500 outline-none transition-all"
 />
 </div>
 ...
 <div className="p-6 border-t border-white/10 bg-transparent/5 flex justify-end">
 <button 
 onClick={handleSaveUser}
 className="btn-primary flex items-center gap-2 px-4 py-2 text-white font-medium rounded-md transition-colors"
 >
 ...
 <p className="text-sm text-white/60 mt-1">This information will be used to guide AI generations to match your brand.</p>
 </div>
 ...
 rows={4}
 className="w-full px-3 py-2 bg-transparent/5 border border-white/10 rounded-md focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none"
 />
 </div>
 </div>
 </div>
