...
export function ReadabilityRing({ text }: { text: string }) {
 ...
 return (
 <div className="flex items-center gap-4 p-4 glass-card shadow-sm">
 ...
 <div className="absolute flex items-center justify-center font-bold text-slate-800 ">
 {score}
 </div>
 </div>
 <div>
 <h4 className="text-sm font-semibold text-white ">Readability</h4>
 <p className="text-xs text-white/60 mt-0.5">Score: {label}</p>
 </div>
 </div>
 );
}
